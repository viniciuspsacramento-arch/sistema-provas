...
CREATE TABLE IF NOT EXISTS provas (
    ...
    titulo_publico VARCHAR(200) COMMENT 'Título exibido para o aluno (se NULL, usa o título interno)',
    descricao TEXT,
...
BEGIN
    ...
    -- Calcular acertos (considerando valor das questões se houver)
    -- Por enquanto considera peso igual (ou use SUM(valor) se implementar peso)
